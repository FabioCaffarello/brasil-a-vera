...
- [ADR-037 — Modelagem do grafo de participação societária](../architecture/ADR/037-grafo-participacao-societaria.md) (accepted; ego-grafo por parlamentar via query cacheada, CNPJ determinístico, ReactFlow na camada BaV, L3)
