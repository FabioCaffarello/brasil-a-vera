      ...
      <search>
        <form action="/busca" method="get" className="flex items-center">
          ...
          <input
            ...
            placeholder="Buscar…"
            autoComplete="off"
            className="w-32 rounded border border-zinc-300 bg-white px-2 py-1 text-sm placeholder:text-zinc-400 focus:w-48 focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-600 dark:bg-zinc-800 dark:placeholder:text-zinc-500 sm:w-48 sm:focus:w-64"
          />
        </form>
      </search>
    )
    ...
    <search>
      <form action="/busca" method="get" className="flex items-center gap-2">
        ...
        <input
          ...
          autoComplete="off"
          className="flex-1 rounded-md border border-zinc-300 bg-white px-3 py-2 text-base placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-600 dark:bg-zinc-800 dark:placeholder:text-zinc-500"
        />
        <button
          type="submit"
