  ...
  return (
    <>
      ...
      <HeroSection
        align="center"
        description={
          'Percentual de votações nominais no plenário em que o parlamentar registrou voto (não ausente), calculado na janela do seu mandato. Inclui apenas parlamentares com ao menos 10 votações elegíveis.'
        }
