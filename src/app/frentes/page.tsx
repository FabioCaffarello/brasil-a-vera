  ...
  return (
    <>
      ...
      <HeroSection
        align="center"
        description={
          'Agrupamentos suprapartidários da Câmara dos Deputados organizados em torno de causas ou temas comuns. Qualquer parlamentar pode integrar uma frente independentemente do partido.'
        }
