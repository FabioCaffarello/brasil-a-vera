// Cópia-rds de src/app/(authenticated)/painel/@alertas/page.tsx — migração
// painel (área logada /rds/painel). Slot Alertas (RSC).
//
...
import { ListaRecebidos } from '../_components/lista-recebidos'
import { SubTabsAlertas } from '../_components/sub-tabs-alertas'
