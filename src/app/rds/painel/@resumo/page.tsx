// Cópia-rds de src/app/(authenticated)/painel/@resumo/page.tsx — migração
// painel (área logada /rds/painel). Slot Resumo (RSC orquestrador).
//
...
//
// `OnboardingWizard` importado do ORIGINAL (client island — modal full-screen).
// `EstadoMaduro/Novo/Onboarding` → cópias locais traduzidas em ../_components.
//
...
import { EstadoMaduro } from '../_components/estado-maduro'
import { EstadoNovo } from '../_components/estado-novo'
import { EstadoOnboarding } from '../_components/estado-onboarding'
