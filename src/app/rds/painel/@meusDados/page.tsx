// Cópia-rds de src/app/(authenticated)/painel/@meusDados/page.tsx — migração
// painel (área logada /rds/painel). Slot Meus dados (RSC) — dashboard LGPD em
...
//
// Href "voltar" reescrito pra /rds/painel?tab=configuracoes.
  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 py-8">
      <Link
        ...
        href="/rds/painel?tab=configuracoes"
      >
