// Piloto-5: cópia-rds de /feed sob /rds/ (strangler fig, ADR-033).
// Convive em paralelo com a rota original; promoção é decisão futura.
//
// Rota textual sem componentes de domínio em src/components/ — o helper
// local (FeedGroup) é reconstruído AQUI, como na piloto-1 (helper local
// não vira arquivo separado). Espelhamento é em nível de página: par
// registrado em docs/migration/consolidation-debt.md.
//
...
// interna com contraparte sob /rds/. Mesmo regime dos cross-links de
// entidade das pilotos 2–4.
//
...
export const metadata: Metadata = {
  title: 'Feeds RSS (rds-pilot) — Brasil à Vera',
  description:
    'Inscreva-se em feeds RSS segmentados de votações: por casa, UF, partido ou tema.',
}

// Mesma justificativa da rota original: lista partidos e temas vivos do
// banco; build com placeholder DATABASE_URL não pré-renderiza.
