// Cópia-rds de src/design-system/primitives/button.tsx — onda HeroSection
// (home /). Reuso VERBATIM das cópias das listagens #1/#2/#3 e da /busca/
// /comparar (apresentacional puro, sem href/rota embutida — só o header de
// comentário muda). O Button do RDS NÃO está no /server (é client; +JS contra
// ADR-022) e o local diverge em token de marca; por isso a cópia local
// traduzida, mantendo zero-JS e token-clean. Usos na home: CTA default
// (asChild → Link "Explorar parlamentares") + variant="ghost" (Link
// "Ver proposições").
//
...
// régua das pilotos 2–4): brand-foreground (on-color do CTA),
// destructive / destructive-foreground (variante destructive não usada
// na home, preservada para paridade de API).
