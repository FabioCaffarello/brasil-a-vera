...
// onda HeroSection (listagem /proposicoes). Reuso VERBATIM da cópia
// traduzida da piloto-3 (mesmo original; usada lá pelo SectionCard do
// detalhe, aqui pelo ProposicaoCard da listagem — original INTOCADO,
// par registrado na consolidation-debt). Server Component CSS-only.
//
