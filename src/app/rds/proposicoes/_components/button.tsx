...
// (listagem /proposicoes). Reuso verbatim da cópia da listagem
// /parlamentares (apresentacional puro, sem href/rota embutida). O Button
// do RDS NÃO está no /server (é client; +JS contra ADR-022) e o local
// diverge em token de marca; por isso a cópia local traduzida, mantendo
// zero-JS e token-clean.
//
