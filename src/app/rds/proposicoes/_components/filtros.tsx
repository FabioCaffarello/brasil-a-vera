// Cópia-rds de src/components/proposicao/filtros.tsx — onda HeroSection
// (listagem /proposicoes). Original INTOCADO.
//
// Substituições estruturais vs original (mesmo padrão da listagem
// /parlamentares, §3.14):
...
// - Input (busca)          → <input> cru traduzido (precedente filtros
//                            /parlamentares — evita importar o Input do
//                            original com tokens BaV não traduzidos; zero-JS)
...
//
// hrefs, form `action` e link "Limpar" reescritos para /rds/proposicoes
// (estado de filtro CONTIDO na rota staging).
//
...
function buildHref(
  ...
  return query ? `/rds/proposicoes?${query}` : '/rds/proposicoes'
}
      ...
      >
        ...
        <div className="flex justify-end gap-2">
          <Button asChild size="sm" variant="outline">
            <a href="/rds/proposicoes">Limpar</a>
          </Button>
