// Cópia-rds de src/components/proposicao/footer-cross-links.tsx
// (piloto-3). Server Component. Contratos de fallback EXATOS (P2 —
// bloco só renderiza com ≥1 item). Links de destino apontam para as
// rotas de PRODUÇÃO (fora do escopo da staging).
