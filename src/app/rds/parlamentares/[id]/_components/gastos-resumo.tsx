// Cópia-rds de src/components/parlamentar/gastos-resumo.tsx (piloto-2).
// Server Component. GastosChart (recharts, dynamic import ssr:false)
// importado do original — client island compartilhado, sem tradução
// neste PR (pendência registrada). Link drill-down usa text-accent
// MANTIDO (roxo data-viz BaV sem equivalente RDS — resíduo registrado).
