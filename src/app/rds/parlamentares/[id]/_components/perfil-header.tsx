// Cópia-rds de src/components/parlamentar/perfil-header.tsx (piloto-2).
// Server Component. Estrutura semântica EXATA preservada (<header>,
// dl/dt/dd, breadcrumb). Só os tokens são traduzidos pela tabela
// canônica (docs/migration/token-map.md). Client islands compartilhados
// (CompartilharButton, TrustBadge) e composições sem equivalente RDS
// (DataBadge, PartyBadge) importados dos originais — pendência
// registrada em docs/migration/consolidation-debt.md.
