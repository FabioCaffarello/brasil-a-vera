// Cópia-rds de src/components/parlamentar/votos-recentes.tsx (piloto-2).
// Server Component. Lógica de filtros/paginação EXATA preservada; SVG-free
// DistribuicaoBar preservada (CSS-only). Tokens traduzidos pela tabela
// canônica + extensão piloto-2 (bg-destructive→bg-error, text-destructive→
// text-fg-error; bg-success/bg-warning mantêm nome — RDS define
