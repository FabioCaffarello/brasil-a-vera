// Cópia-rds de src/components/parlamentar/alinhamento.tsx (piloto-2).
// Server Component puro. Limiares de cor EXATOS (≥80 success / ≥50
// neutro / <50 warning — mesmo padrão da FidelidadeMediaBlock da
// piloto-1). Sparkline SVG inline preservada byte-a-byte exceto tokens:
// stroke-border→stroke-line-default; text-accent/fill-accent MANTIDOS
// (roxo data-viz BaV sem equivalente RDS — resíduo registrado na
// tabela canônica, piloto-2).
