...
// HeroSection (rota /busca). Reuso da tradução já feita na listagem
// /rds/parlamentares (§3.14) — espelho verbatim, exceto este header.
...
//   `follow` é undefined, zero HTML/JS do botão — anônimo não vê). /busca
//   NÃO passa `follow` (igual ao original), logo o footer-action nunca
//   renderiza nesta rota.
...
// /rds/; navegação CONTIDA na staging).
//
...
// (barra CSS-only do AlinhamentoStrip; em /busca a query não traz
// pctAlinhamento/votacoesAnalisadas, então o card cai no branch sem_dado
// e a barra não chega a renderizar).
