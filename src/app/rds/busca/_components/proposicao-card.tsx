...
// /rds/proposicoes (§3.15) — espelho verbatim, exceto este header.
...
//   Em /busca a query não traz os agregados de tramitação, então o card cai
//   no branch sem_tramitacao_registrada e a barra não chega a renderizar.
//
