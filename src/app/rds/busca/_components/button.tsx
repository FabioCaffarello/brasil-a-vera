...
// (rota /busca). Reuso VERBATIM das cópias das listagens #1/#2/#3 (o
// Button do RDS NÃO está no /server — é client, +JS contra ADR-022 — e o
// local diverge em token de marca; cópia local traduzida mantém zero-JS e
// token-clean). Usado pelo SearchForm local (botão "Buscar", submit).
//
...
// nesta rota, preservada para paridade de API).
