...
// HeroSection (rota /busca). Reuso VERBATIM da cópia da piloto-2
// (src/app/rds/parlamentares/[id]/_components/section-card.tsx):
...
// inerte em /busca, que não usa SectionNav, mas mantido por paridade da
// cópia verbatim).
//
