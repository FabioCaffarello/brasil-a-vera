// Cópia-rds de src/components/votacao/rebeldes-list.tsx (piloto-4).
// Server Component puro. Tokens traduzidos pela tabela canônica.
// `getTipoVotoStyle` retorna classes BaV não traduzidas (precedente
// piloto-2: lógica de domínio única, traduz na promoção).
// Links de parlamentar apontam pra rota de PRODUÇÃO (precedente
