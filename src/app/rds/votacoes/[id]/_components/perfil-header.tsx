// Cópia-rds de src/components/votacao/perfil-header.tsx (piloto-4).
// Server Component. Tokens traduzidos pela tabela canônica
// (docs/migration/token-map.md). Client islands / composições
// compartilhadas (DataBadge, TrustBadge, CompartilharVotacaoButton)
// importadas dos ORIGINAIS (precedente piloto-2/3).
// Breadcrumb aponta pra listagem de PRODUÇÃO (/votacoes) — precedente
// piloto-3 (cross-links de entidade não ficam sob /rds/).
